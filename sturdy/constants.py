...
QUERY_FREQUENCY = 45  # time in seconds between validator queries
...
MINER_SYNC_FREQUENCY = 3000  # time in seconds between miner syncs

UNISWAP_V3_LP_QUERY_FREQUENCY = 36000  # time in seconds between Uniswap V3 LP queries
